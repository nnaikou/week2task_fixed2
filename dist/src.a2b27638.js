...
function YesPicture(imgSrc) {
  ...
  if (k > 0) {
    var usernameTemporary = username0 + " [" + (k - 1) + "]";
    if (document.querySelector("#input-admin").checked) {
      newCell.innerHTML = "<td>" + usernameTemporary + "</td><td>" + email0 + "</td><td>" + address0 + "</td><td>X</td><td><img src='" + imgSrc + "'width='64' height='64'></td>";
    } else {
      newCell.innerHTML = "<td>" + usernameTemporary + "</td><td>" + email0 + "</td><td>" + address0 + "</td><td>-</td><td><img src='" + imgSrc + "'width='64' height='64'></td>";
    }
  } else {
    if (document.querySelector("#input-admin").checked) {
      newCell.innerHTML = "<td>" + username0 + "</td><td>" + email0 + "</td><td>" + address0 + "</td><td>X</td><td><img src='" + imgSrc + "'width='64' height='64'></td>";
    } else {
      newCell.innerHTML = "<td>" + username0 + "</td><td>" + email0 + "</td><td>" + address0 + "</td><td>-</td><td><img src='" + imgSrc + "'width='64' height='64'></td>";
    }
  }
  tableBody.appendChild(newCell);
  users.push({
